...
def test_index_admin_logged_in_admin_dashboard_table(client: FlaskClient, admin_logged_in):
    with client:
        ...
        # name
        assert f'<span class=" fw-bolder"><a class="link-dark link-offset-2 link-underline-opacity-50 link-underline-opacity-100-hover" href="{url_for("users.edit_user", username="user1")}">user1</a>' in response.text
        assert f'<span class=" fw-bolder"><a class="link-dark link-offset-2 link-underline-opacity-50 link-underline-opacity-100-hover" href="{url_for("users.edit_user", username="user2")}">user2</a>' in response.text
        assert f'<span class=""><a class="link-dark link-offset-2 link-underline-opacity-50 link-underline-opacity-100-hover" href="{url_for("users.edit_user", username="user3")}">user3</a>' in response.text
        assert f'<span class=""><a class="link-dark link-offset-2 link-underline-opacity-50 link-underline-opacity-100-hover" href="{url_for("users.edit_user", username="user4")}">user4</a>' in response.text
        assert f'<span class=""><a class="link-dark link-offset-2 link-underline-opacity-50 link-underline-opacity-100-hover" href="{url_for("users.edit_user", username="user5")}">user5</a>' in response.text
        assert f'<span class="text-decoration-line-through"><a class="link-dark link-offset-2 link-underline-opacity-50 link-underline-opacity-100-hover" href="{url_for("users.edit_user", username="user6")}">user6</a>' in response.text
        with dbSession() as db_session:
            db_session.get(User, 6).admin = True
            db_session.commit()
            response = client.get("/")
            assert f'<span class="text-decoration-line-through fw-bolder"><a class="link-dark link-offset-2 link-underline-opacity-50 link-underline-opacity-100-hover" href="{url_for("users.edit_user", username="user6")}">user6</a>' in response.text
