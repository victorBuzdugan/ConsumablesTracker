    ...
    ("name", "description", "responsible_id", "category_id", "supplier_id",
     "meas_unit", "min_stock", "ord_qty", "flash_message"), (
        ("", "some description", 1, 1, 1,
         "pc", 0, 1, str(Message.Product.Name.Required())),
        ...
        ("new_product", "", 1, 1, 1,
         "pc", 0, 1, str(Message.Product.Description.Required())),
        ...
        "", 0, 1, str(Message.Product.MeasUnit.Required())),
        ("new_product", "some description", 1, 1, 1,
        "pc", "", 1, str(Message.Product.MinStock.Required())),
        ("new_product", "some description", 1, 1, 1,
        "pc", -1, 1, str(Message.Product.MinStock.Invalid())),
        ("new_product", "some description", 1, 1, 1,
        "pc", "a", 1, "Not a valid integer value"),
        ("new_product", "some description", 1, 1, 1,
        "pc", 0, "", str(Message.Product.OrdQty.Required())),
        ("new_product", "some description", 1, 1, 1,
    ...
    ("prod_id", "new_name", "new_description",
     ...
     "flash_message"), (
        ...
        ("24", "new_product", "new description",
         1, 1, 1,
         "new_meas_unit", "", 100,
         str(Message.Product.MinStock.Required())),
        ...
        1, 1, 1,
        "new_meas_unit", 100, "",
        str(Message.Product.OrdQty.Required())),
